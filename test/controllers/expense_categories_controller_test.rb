...
class ExpenseCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create expense_category" do
    assert_difference('ExpenseCategory.count') do
      post :create, expense_category: { description: @expense_category.description, title: @expense_category.title, user_id: @expense_category.user_id }
    end
  ...
  test "should update expense_category" do
    patch :update, id: @expense_category, expense_category: { description: @expense_category.description, title: @expense_category.title, user_id: @expense_category.user_id }
    assert_redirected_to expense_category_path(assigns(:expense_category))
  end
