...
class IncomesControllerTest < ActionController::TestCase
  ...
  test "should create income" do
    assert_difference('Income.count') do
      post :create, income: { date: @income.date, income_category_id: @income.income_category_id, price: @income.price }
    end
  ...
  test "should update income" do
    patch :update, id: @income, income: { date: @income.date, income_category_id: @income.income_category_id, price: @income.price }
    assert_redirected_to income_path(assigns(:income))
  end
